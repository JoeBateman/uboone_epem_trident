                         ...
                         double px, double py, double pz)
{
  ...
  // Beam -> detector offset (cm) (NuMI origin in detector coordinates)
...
string basePath = "/pnfs/uboone/persistent/uboonebeam/numi_dk2nu_zero_threshold/gsimple/RHC/gsimple_microboone-numi-v2_g4numiv6_minervame_me000z-200i_";
string outFileName = "/exp/uboone/app/users/jbateman/workdir/DarkNews/Trident/data/flux/numi/NuMI_gsimple_RHC_FluxHist_w2D_hists.root";

// string basePath = "/pnfs/uboone/persistent/uboonebeam/numi_dk2nu_zero_threshold/gsimple/FHC/gsimple_microboone-numi-v2_g4numiv6_minervame_me000z200i_";
// string outFileName = "/exp/uboone/app/users/jbateman/workdir/DarkNews/Trident/data/flux/numi/NuMI_gsimple_FHC_FluxHist_w2D_hists.root";


void make_2d_flux_hists_NuMI(){
  ...
  nfiles = 1100; // Number of flux files to iterate over
  std::cout << "only using " << nfiles << " files for now." << std::endl;
  ...
  for(int iFile=0;iFile<nfiles;iFile++){
    ...
    string inFile = basePath + fileIndex + "_0000_00001.root"; // Adjusted for numi file naming convention
  ...
  // Approximate area of the uBooNE detector as seen from the NuMI target (cm^2)
  // This is calcualted in /exp/uboone/app/users/jbateman/workdir/MeVPrtl/NuMI/NuMI_solid_angle.ipynb
  double activeVolFace = 170256.08; // in cm^2
